defmodule SignalNetwork.Network.PartitionTracker do
  @moduledoc """
  ...
  @spec gaps() :: [map()]
  def gaps do
    GenServer.call(__MODULE__, :gaps)
  end
  ...
  @impl true
  def handle_call(:gaps, _from, state), do: {:reply, Enum.reverse(state.gaps), state}
